...
public class LeftHandGrabbingServoLocation extends Location {
    ...
    public LeftHandGrabbingServoLocation(HardwareMap hardware) {
        try {
            SERVO = new StandardServo(hardware, Resources.Hand.Servos.LeftGrabbing);
