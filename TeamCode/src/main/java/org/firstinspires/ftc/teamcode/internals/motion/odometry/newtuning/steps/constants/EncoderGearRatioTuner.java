...
public class EncoderGearRatioTuner extends Feature implements Conditional {
    ...
    @Override
    public void loop() {
        Questions.ask(new Menu.MenuBuilder().setDescription("Set the ENCODER_GEAR_RATIO to your dead wheel gear ratio, then select Ok.").addItem("Ok").build(), Devices.controller1);
