package org.firstinspires.ftc.teamcode.internals.odometry.drivers;
...
import org.firstinspires.ftc.teamcode.internals.odometry.OdometrySettings;
import org.firstinspires.ftc.teamcode.internals.odometry.trajectories.TrajectorySequence;
import org.firstinspires.ftc.teamcode.internals.odometry.trajectories.TrajectorySequenceBuilder;
import org.firstinspires.ftc.teamcode.internals.odometry.trajectories.TrajectorySequenceRunner;
import org.firstinspires.ftc.teamcode.internals.odometry.utils.LynxModuleUtil;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;

import static org.firstinspires.ftc.teamcode.internals.odometry.OdometrySettings.*;
...
public class AutonomousDriver extends MecanumDrive {
    ...
    public AutonomousDriver(HardwareMap hardwareMap) {
        ...
        leftFront = hardwareMap.get(DcMotorEx.class, DRIVE_FRONT_LEFT.NAME);
        leftRear = hardwareMap.get(DcMotorEx.class, DRIVE_BACK_LEFT.NAME);
        rightRear = hardwareMap.get(DcMotorEx.class, DRIVE_BACK_RIGHT.NAME);
        rightFront = hardwareMap.get(DcMotorEx.class, DRIVE_FRONT_RIGHT.NAME);
        ...
        leftFront.setDirection(DRIVE_FRONT_LEFT.DIRECTION);
        leftRear.setDirection(DRIVE_BACK_LEFT.DIRECTION);
        rightRear.setDirection(DRIVE_BACK_RIGHT.DIRECTION);
        rightFront.setDirection(DRIVE_FRONT_RIGHT.DIRECTION);
