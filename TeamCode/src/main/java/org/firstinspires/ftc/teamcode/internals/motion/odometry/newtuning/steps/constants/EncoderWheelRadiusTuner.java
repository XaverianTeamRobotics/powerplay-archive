...
public class EncoderWheelRadiusTuner extends Feature implements Conditional {
    ...
    @Override
    public void loop() {
        Questions.ask(new Menu.MenuBuilder().setDescription("Set the ENCODER_WHEEL_RADIUS to your dead wheels' radii in inches, then select Ok.").addItem("Ok").build(), Devices.controller1);
