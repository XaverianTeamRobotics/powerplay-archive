...
public class WheelRadiusTuner extends Feature implements Conditional {
    ...
    @Override
    public void loop() {
        Questions.ask(new Menu.MenuBuilder().setDescription("Set the WHEEL_RADIUS to your drive wheels' radii in inches, then select Ok.").addItem("Ok").build(), Devices.controller1);
